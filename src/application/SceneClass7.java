...
public class SceneClass7{
	...
	@FXML
	private TextField textfieldLen2;
	@FXML
	private TextField textfieldLen1;
...
//        dialog.show();
    ...
    public static String generatePassword(String symbols, String len)
    {
        
        SecureRandom random = new SecureRandom();
        StringBuilder sb = new StringBuilder();
        int valuenum = Integer.valueOf(len);
    ...
    {
    	textarea1.setText(generatePassword(textfieldLen2.getText(), textfieldLen1.getText()));
